...
const CATALOG: Group[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { kind: 'classic', type: 'dema', label: 'Double EMA', desc: 'Two cascaded EMAs minus lag.' },
      { kind: 'classic', type: 'tema', label: 'Triple EMA', desc: 'Three cascaded EMAs — low lag.' },
      { kind: 'classic', type: 'vwma', label: 'Volume Weighted MA', desc: 'SMA weighted by volume.' },
      { kind: 'classic', type: 'smma', label: 'Smoothed MA (RMA)', desc: "Wilder's smoothed MA." },
      { kind: 'classic', type: 'alma', label: 'Arnaud Legoux MA', desc: 'Gaussian-weighted, low lag.' },
      { kind: 'classic', type: 'lsma', label: 'Least Squares MA', desc: 'Linear-regression endpoint curve.' },
      { kind: 'classic', type: 'kama', label: 'Kaufman Adaptive MA', desc: 'Adapts speed to efficiency ratio.' },
      { kind: 'classic', type: 't3', label: 'Tillson T3', desc: 'Six-EMA smooth, very low lag.' },
      { kind: 'classic', type: 'zlema', label: 'Zero-Lag EMA', desc: 'EMA of a de-lagged series.' },
      { kind: 'classic', type: 'mcginley', label: 'McGinley Dynamic', desc: 'Self-adjusting MA that hugs price.' },
    ],
  },
  {
